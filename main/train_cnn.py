...
MODEL_PATH = r"main/trained_models_cnn/1.zip"
...
class CustomVecEnv(VecEnvWrapper):
    def __init__(self, env):
        super().__init__(env)

    def get_action_mask(self):
        # Implement your action mask logic here
        pass


# Wrap the environment with the custom VecEnv
